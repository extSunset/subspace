...
use subspace_core_primitives::{Blake2b256Hash, SectorIndex, SolutionRange, Record, RecordedHistorySegment};
...
pub(crate) fn benchmark_proving(benchmark_args: BenchmarkArgs) -> Result<()> {
    let BenchmarkArgs {
        base_path,
        mut sector_count,
        sample_size,
    ...
    debug!("Opening a metadata file. path = {}", metadata_file_path.display());
